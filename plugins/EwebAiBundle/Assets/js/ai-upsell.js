...
(function () {
  ...
  function injecterStyles() {
    ...
    st.textContent = ''
      ...
      + '#sendly-ia-upsell a.cta { position: relative; display: flex; align-items: center; justify-content: center; gap: 9px; width: 100%; border-radius: 999px; background-color: #004FFF; background-image: linear-gradient(120deg, rgba(255,255,255,.28), rgba(255,255,255,.07) 40%, rgba(255,255,255,.20)); color: #fff; font-size: 14.5px; font-weight: 500; letter-spacing: .005em; padding: 14px 0; text-decoration: none; box-shadow: 0 10px 24px rgba(0,79,255,.32), inset 0 1px 0 rgba(255,255,255,.38); transition: background-color .15s, transform .18s, box-shadow .18s; }'
      ...
      + '#sendly-ia-upsell a.cta:hover { background-color: #0033B8; background-image: linear-gradient(120deg, rgba(255,255,255,.32), rgba(255,255,255,.10) 40%, rgba(255,255,255,.24)); color: #fff; text-decoration: none; transform: translateY(-1px); box-shadow: 0 14px 28px rgba(0,79,255,.38), inset 0 1px 0 rgba(255,255,255,.38); }'
