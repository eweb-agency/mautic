...
(function () {
  ...
  function injecterStyles() {
    ...
    st.textContent = ''
      ...
      + '#sendly-ia-upsell a.cta { position: relative; display: flex; align-items: center; justify-content: center; gap: 9px; width: 100%; border-radius: 999px; background-color: #004FFF; background-image: linear-gradient(120deg, rgba(255,255,255,.14), rgba(255,255,255,0) 45%), linear-gradient(180deg, #2E6BFF, #004FFF 60%, #0043E0); color: #fff; font-size: 14.5px; font-weight: 500; letter-spacing: .005em; padding: 14px 0; text-decoration: none; box-shadow: 0 4px 14px rgba(0,79,255,.20), inset 0 1px 0 rgba(255,255,255,.35); transition: background-color .15s, transform .18s, box-shadow .18s; }'
      + '#sendly-ia-upsell a.cta::before { content: ""; position: absolute; inset: 0; border-radius: 999px; padding: 1.5px; background: linear-gradient(130deg, rgba(255,255,255,.85), rgba(255,255,255,.18) 35%, rgba(255,255,255,.14) 62%, rgba(255,255,255,.65)); -webkit-mask: linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0); -webkit-mask-composite: xor; mask-composite: exclude; pointer-events: none; }'
      + '#sendly-ia-upsell a.cta:hover { background-color: #0033B8; background-image: linear-gradient(120deg, rgba(255,255,255,.16), rgba(255,255,255,0) 45%), linear-gradient(180deg, #1F55E8, #0033B8 60%, #002DA6); color: #fff; text-decoration: none; transform: translateY(-1px); box-shadow: 0 8px 20px rgba(0,79,255,.28), inset 0 1px 0 rgba(255,255,255,.35); }'
