...
(function () {
  ...
  function injecterStyles() {
    ...
    st.textContent = ''
      ...
      + '#sendly-ia-upsell a.cta:hover { background-color: #0033B8; background-image: linear-gradient(120deg, rgba(255,255,255,.32), rgba(255,255,255,.10) 40%, rgba(255,255,255,.24)); color: #fff; text-decoration: none; transform: translateY(-1px); box-shadow: 0 8px 20px rgba(0,79,255,.28), inset 0 1px 0 rgba(255,255,255,.38); }'
